## 2026-01-14 17:34:58 UTC: Embed benchmark snapshot
...
- torch: 2.9.1+cu128
- git: unknown (unknown)
- command: `scripts/run_embed_bench.py --input docs/embed.md --engine kernel --mode float --threads 16 --batch-size 64 --max-bytes 4096 --warmup 1 --repeat 3 --presets small`
...
| --- | --- | --- | --- | --- | --- | --- |
| small | OK | 1.77 | 1.67 | 1.76 | 144969.39 | 36242.35 |
